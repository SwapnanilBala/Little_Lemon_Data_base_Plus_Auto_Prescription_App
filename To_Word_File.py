...
def print_file():
    file_path = r"C:\Users\GOGOL\Downloads\Printable_Updated_Prescription.docx"
    if os.path.exists(file_path):
        win32api.ShellExecute(
            0, "print", file_path, None, ".", 0
        )
        Form_Status.insert(0, "The document has been sent to the printer for printing.")
    else:
        Form_Status.insert(0, "Error: The file does not exist")
